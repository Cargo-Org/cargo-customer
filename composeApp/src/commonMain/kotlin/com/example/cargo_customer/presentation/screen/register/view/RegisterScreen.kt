...
private fun RegisterScreenContent(
    ...
    onInteraction: (RegisterInteractionListener) -> Unit,
    ...
    Box(
        ...
        Column(
            ...
            InputField(
                value = state.name,
                onValueChanged = {onInteraction(RegisterInteractionListener.OnNameChanged(it))},
            ...
            InputField(
                value = state.email,
                onValueChanged = {onInteraction(RegisterInteractionListener.OnEmailChanged(it))},
            ...
            InputField(
                value = state.phone,
                onValueChanged = {onInteraction(RegisterInteractionListener.OnPhoneChanged(it))},
            ...
            InputField(
                ...
                onValueChanged = { onInteraction(RegisterInteractionListener.OnPasswordChanged(it)) },
                ...
                onVisibilityChange = { onInteraction(RegisterInteractionListener.OnTogglePasswordVisibility) },
            ...
            ColoredActionButton(
                ...
                onClick = {onInteraction(RegisterInteractionListener.OnRegisterClicked)}
            )
            OrDivider(
            ...
            AuthFooterText(
                ...
                onClick = {onInteraction(RegisterInteractionListener.OnSignInClicked)}
            )
        }
    }
}
